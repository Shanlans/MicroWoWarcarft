...
const Quests = (() => {
  ...
  const DB = {
    ...
    q_clear_mines: {
      ...
      giver: 'gryanStoutmantle',
      title: '矿洞清扫',
      desc: '进入死亡矿井,清除盘踞在第一大厅的豺狼人。\n\n从西部荒野中部的石头建筑进入副本。',
      objectives: [{ type: 'kill', target: 'gnoll', count: 6, text: '击杀豺狼人' }],
      reward: { xp: 250, gold: 80, items: ['chainMail'] },
    },
    q_foreman: {
      id: 'q_foreman',
      giver: 'dungeonGuide',
      title: '迪菲亚监工',
      desc: '死亡矿井深处有迪菲亚监工在指挥工人。\n消灭他们,削弱范克里夫的力量。',
      objectives: [{ type: 'kill', target: 'dforeman', count: 2, text: '击杀迪菲亚监工' }],
      reward: { xp: 350, gold: 120, items: ['ironHelm'] },
    },
    q_vancleef: {
      id: 'q_vancleef',
      giver: 'gryanStoutmantle',
      title: '范克里夫的末日',
      desc: '进入死亡矿井最深处,击杀迪菲亚首领范克里夫!\n\n建议等级: 10 级以上。Boss 有多阶段机制。',
